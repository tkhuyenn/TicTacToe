...
root = Tk()
root.geometry("1350x750+0+0")  # 1,2: kích thước cửa sổ; 3,4: vị trí
...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text="Tic Tac Toe Game", bd=21, bg='lightcyan', fg='black',
                 justify=CENTER)
...
RightFrame = Frame(MainFrame, bd=10, width=560, height=500, pady=10, padx=2, bg='lightcyan', relief=RIDGE)
...
lblPlayerX = Label(RightFrame1, font=('arial', 40, 'bold'), text="Player X:", padx=2, pady=2, bg='lightcyan')
...
lblPlayerO = Label(RightFrame1, font=('arial', 40, 'bold'), text="Player O:", padx=2, pady=2, bg='lightcyan')
...
btnNewgame = Button(RightFrame2, text="New Game", font=('Times 26 bold'), height=3, width=20, bg='#5F9EA0',
                    command=NewGame)
btnNewgame.grid(row=1, column=0, padx=6, pady=10)

btnReset = Button(RightFrame2, text="Reset", font=('Times 26 bold'), height=3, width=20, bg='#5F9EA0', command=reset)
btnReset.grid(row=0, column=0, padx=6, pady=10)

button1 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button1))
button1.grid(row=1, column=0, sticky=S + N + E + W)

button2 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button2))
button2.grid(row=1, column=1, sticky=S + N + E + W)

button3 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button3))
button3.grid(row=1, column=2, sticky=S + N + E + W)

button4 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button4))
button4.grid(row=2, column=0, sticky=S + N + E + W)

button5 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button5))
button5.grid(row=2, column=1, sticky=S + N + E + W)

button6 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button6))
button6.grid(row=2, column=2, sticky=S + N + E + W)

button7 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button7))
button7.grid(row=3, column=0, sticky=S + N + E + W)

button8 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
                 command=lambda: checker(button8))
button8.grid(row=3, column=1, sticky=S + N + E + W)

button9 = Button(LeftFrame, text=" ", font=('Times 26 bold'), height=3, width=8, bg='#5F9EA0',
